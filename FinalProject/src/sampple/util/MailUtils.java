...
public class MailUtils {
	...
	//user:用戶的bean
    public static void sendMail(String type, Users user, String url) throws AddressException, MessagingException, GeneralSecurityException, UnsupportedEncodingException{
    	//取得用戶email
